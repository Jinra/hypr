...
-- Reset Display
-- hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("hyprctl keyword monitor DP-1,2560x1440@360,2560x0,1,vrr,3 && hyprctl reload"))
...
-- hyprctl dispatch 'hl.monitor({ output = "DP-1", mode = "2560x1440@360", position = "2560x0", scale = "1", bitdepth = 8 })' && hyprctl reload
